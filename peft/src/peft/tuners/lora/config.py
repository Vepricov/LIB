...
class LoraConfig(PeftConfig):
    ...
    Args:
        ...
        use_weight_lora (`bool`):
            To use the weighted version of the LoRA adapters. Paper: https://arxiv.org/pdf/2506.02724.
    ...
    use_weight_lora: bool = field(
        default=False,
        metadata={
            "help": (
                "To use the weighted version of the LoRA adapters. "
                "This can be used to furver optimize over this weights with some constraints. "
                "Paper: https://arxiv.org/pdf/2506.02724."
            )
        },
    )
